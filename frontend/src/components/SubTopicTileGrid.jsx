export default function SubTopicTileGrid({ options, subTopics, onSelect, disabled }) {
  ...
  return (
    <div className="module-list">
      {visibleOptions.map((option) => {
        ...
        return (
          <button key={option.id} className="module-tile subtopic-tile" disabled={disabled} onClick={() => onSelect(option)}>
            <div className="subtopic-tile-fill" style={{ width: `${percent}%`, borderRightWidth: percent > 0 ? '2px' : '0' }} />
